...
import com.idat.ecdanielmeza.service.ClienteService;



@Controller
@RequestMapping("EC2-DanielMeza/cliente/v1") 
public class ClienteController {
	...
	public ResponseEntity<Void> eliminar( @PathVariable Integer id  ) {
		...
		Cliente p = service.obtenerClienteId(id);
	...
	public ResponseEntity<Void> actualizar( @RequestBody Cliente cliente ) {
		...
		Cliente p = service.obtenerClienteId(cliente.getIdCliente());
